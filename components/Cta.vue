...
<template>
  <div
    class="flex flex-col items-center px-10 py-10 mx-auto mb-20 text-center border-2 border-blue-500 border-dashed rounded-lg sm:px-20 sm:py-20">
    ...
    <div class="flex flex-wrap gap-4 mt-8">
      <div v-for="button of buttons">
        <NuxtLink v-if="button.label && button.url" :href="button.url"
          class="inline-flex px-6 py-3 text-white duration-300 bg-blue-600 rounded-sm hover:bg-blue-800 transition-color">
